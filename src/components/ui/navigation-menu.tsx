...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        'h-full group flex flex-1 list-none items-center justify-center gap-1',
        className,
      )}
      {...props}
    />
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        'group-data-[viewport=false]/navigation-menu:bg-neutral-100 group-data-[viewport=false]/navigation-menu:text-popover-foreground',
    ...
    >
      <div
        className={cn(
          'bg-white p-4 ',
          'rounded-lg border border-neutral-200 shadow-xs',
          className,
        )}
        {...props}
      />
...
function NavigationMenuViewport({
  ...
  return (
    ...
    <div
      className={cn(
        'absolute top-full left-0 right-0 isolate z-50',
        'flex justify-center w-full max-w-[95vw] lg:w-[80vw] perspective-[2000px]',
        'mx-auto',
        className,
      )}
    >
      ...
      <NavigationMenuPrimitive.Viewport
        className={cn(
          'w-full  relative mt-2.5 bg-white',
          'overflow-hidden rounded-md border shadow',
          'transition-[width,_height,transform] duration-500 origin-[top_center]',
